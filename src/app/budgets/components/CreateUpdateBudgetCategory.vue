<template>
  <tr id="budget-category-create-edit-view">
    <td>
      <multiselect :value="budgetCategory.category" @input="updateCategorySelection" :taggable="true" @tag="handleCreateCategory"
        :options="getCategorySelectList" placeholder="Select or create a category" label="name" track-by="id"></multiselect>
    </td>
    <td>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      updateCategorySelecttion(category) {
